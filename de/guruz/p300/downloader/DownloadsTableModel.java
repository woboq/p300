...
public class DownloadsTableModel extends DefaultTableModel {
	...
	public DownloadsTableModel() {
		super();
		manager = de.guruz.p300.MainDialog.downloadManager;
	...
	protected static DownloadsTableModel i = null;

	public static DownloadsTableModel instance() {
		if (i == null)
			i = new DownloadsTableModel();
