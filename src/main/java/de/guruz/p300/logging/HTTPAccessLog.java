...
public class HTTPAccessLog extends HTTPLog {
	...
	static{
		logger = Logger.getLogger("de.guruz.p300.HTTPAccessLog");
		logger.setLevel(Level.ALL);
		logger.setUseParentHandlers(false);
		

		try {
			String fn = FileNameUtils.replaceVariables (Configuration.instance().getHTTPaccessLog());
	 ...
	 * @see HTTPUploadLog#HTTPuploadLog(String, String, int, long)
	 */
